...
class DeterEngine:
    ...
    def calistir(self, dosya_yolu):
        try:
            with open(dosya_yolu, "r", encoding="utf-8") as dosya:
                # Boş satırları ve yorumları temizle, listeye at
            ...
            while self.i < len(self.satirlar):
                ...
                if satir.startswith("TEKRARLA"):
                    ...
                    self.i += 2 # Döngü ve altındaki satırı geç
                    continue
    ...
    def satir_isle(self, satir):
        ...
        # SORU SORMA
            ...
            parcalar = satir.split("sor")
            degisken = parcalar[0].replace("=", "").strip()
            mesaj = parcalar[1].strip().replace('"', '')
        ...
        # ATAMA VE MATEMATİK
            ...
            try:
                # Karşılaştırma veya matematik kontrolü
